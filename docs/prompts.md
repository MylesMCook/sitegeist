...
### Web-UI Prompts
**File**: shared web-ui prompt definitions
...
1. **Choose the right location**:
   - Shared/reusable tools → the shared web-ui prompt module
...
**Interfaces**:
- Shared web-ui sandbox provider interface - Provider interface

**Prompt Definitions**:
- Shared web-ui prompt definitions - Shared prompts and providers
- `./src/prompts/prompts.ts` - Sitegeist-specific prompts

**Provider Implementations**:
- Shared web-ui artifacts runtime provider - Artifacts provider
...
- Shared web-ui artifacts tool - Artifacts tool
